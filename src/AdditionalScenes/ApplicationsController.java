...
public class ApplicationsController implements Initializable {
    ...
    /**
     * This method will take the user from the view applications page back to the admin main menu
     * @param event mouse event created by clicking the back button
     * @throws IOException 
     */
    @FXML
    ...
    /**
     * This method will open the view application page for a selected application
     * @param event mouse event generated by clicking on the view button
     * @throws IOException 
     */
    @FXML
    ...
    /**
     * I do not know what this method was for
     * @param event mouse event generated by clicking a button
     */
    @FXML
    ...
    /**
     * Start up the Applications view page 
     */
