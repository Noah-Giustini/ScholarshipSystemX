...
public class CreateScholarshipFXMLController implements Initializable {
    ...
    /**
     * This method opens up a new text field for a custom question
     * @param event mouse event generated by clicking the add button
     */
    @FXML
    ...
    /**
     * This method will submit the given form to create a new scholarship and make it available for students to apply
     * @param event mouse event generated by clicking the submit button
     * @throws IOException 
     */
    @FXML
    ...
    /**
     * This method takes us back to the admin main page from the create scholarship page
     * @param event mouse event generated from clicking the back button
     * @throws IOException 
     */
    @FXML
    ...
    /**
     * This method gets the valuse from fields and creates a new scholarship or draft scholarship
     * @param sub bool value indicating if we are going to submit the scholarship or not
     */
